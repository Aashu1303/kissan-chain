...
class _DetailPageWidgetState extends State<DetailPageWidget> {
  ...
  void initState() {
    ...
    _model.inputBidTextController ??= TextEditingController();
    _model.inputBidFocusNode ??= FocusNode();
  }
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    40.0, 0.0, 20.0, 0.0),
                                child: TextFormField(
                                  controller: _model.inputBidTextController,
                                  focusNode: _model.inputBidFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  ...
                                  validator: _model
                                      .inputBidTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                          ...
                          onPressed: () async {
                            await BidsRecord.createDoc(widget!.listingRef!)
                              ...
                              amount: double.tryParse(
                                  _model.inputBidTextController.text),
