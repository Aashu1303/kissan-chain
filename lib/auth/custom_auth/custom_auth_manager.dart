...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    kissanChain2AuthUserSubject.add(
      KissanChain2AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<KissanChain2AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  KissanChain2AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = KissanChain2AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    kissanChain2AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
KissanChain2AuthUser? currentUser;
